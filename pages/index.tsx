...
export default function Home() {
  ...
  return (
    <div className="container mx-auto relative min-h-screen  overflow-hidden ">
        ...
        <div className="relative max-w-6xl w-full flex mx-auto">
          <div className="py-6 bg-white w-full   px-2 sm:px-4 md:px-12 lg:px-[7rem] flex justify-between">
            <div className="flex  items-center">
              <div className="flex items-center gap-1 border-r border-gray-300 mx-[0.30rem]  px-[0.30rem]">
            ...
            <div className="flex gap-8 items-center">
              ...
              <Link href={"#"}>
                <button className="text-white outline-none cursor-pointer text-sm md:text-base rounded-full bg-zinc-700 px-5 py-2">
                  Create wallet
                </button>
              </Link>
            </div>
      ...
      <div
        id="learning"
        className="min-h-screen pt-24  flex flex-col gap-24 items-center"
      >
        ...
        <div className="max-w-4xl relative">
          <div className="w-64 h-64 absolute -top-20 -right-10 open-wallet-gradient"></div>
          <div className="flex flex-col md:flex-row-reverse gap-4 items-center px-[1.375rem]">
            ...
            <div className="flex flex-col text-center md:text-start items-center md:items-start  gap-4">
              ...
              <Link href={"#"}>
                <button className="border-zinc-700 border outline-none cursor-pointer text-sm rounded-full bg-white text-zinc-700 px-5 py-2">
                  Create wallet
                </button>
              </Link>
            </div>
        ...
        <div className="flex flex-col gap-4 items-center px-[1.375rem]">
          <div>
            <Image
              alt="complete course ..."
        ...
        <div className="flex flex-col gap-4 items-center px-[1.375rem]">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <Link href={"#"}>
              <button className="border-zinc-300 border outline-none cursor-pointer text-sm rounded-full bg-white font-secondary text-zinc-600 px-5 py-2">
                Start The Course
              </button>
            </Link>
          </div>
      ...
      <div className="py-24 flex flex-col gap-24 items-center text-center text-zinc-700 px-6">
        <p>
          Visit{" "}
        ...
        <div className="flex flex-col gap-8">
          <div className="grid grid-cols-7 gap-8 items-center justify-center w-full">
            <div>
              <Image
